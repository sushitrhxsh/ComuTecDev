...
if (isset($_SESSION['subject_career'][0])) {
	...
	print "<script>window.setTimeout(function() { window.location = '/sistema-escolar-main/modules/subjects' }, 0000);</script>";
	exit();
}
echo '
<div class="form-data">
...
<script src="/sistema-escolar-main/js/controls/dataexpandable.js"></script>
<script src="/sistema-escolar-main/js/modules/updatesubject.js"></script>
';
