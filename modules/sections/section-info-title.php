...
if (strpos($url_actual, 'modules')) {
    ...
    }elseif($name_page[1] == 'job'){
        $_SESSION['title_form_section'] = 'Oportunidad y promocion de trabajo';
    }
...
<div class="info-school-period">
    <span class="school-period">
        Periodo Escolar /
        <a id="schoolPeriod" href="/sistema-escolar-main/modules/school_period"><?php print $_SESSION['school_period']; ?></a>
    </span>
</div>